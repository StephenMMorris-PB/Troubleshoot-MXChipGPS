...
#define WIRE_ERROR (-1)  //smm: change 1of2: added WIRE_ERROR - not sure I need this, but this is in Arduino library
...
class TwoWire
{
  ...
  public:
    ...
    uint8_t requestFrom(uint8_t, uint8_t, uint32_t, uint8_t, uint8_t); // smm: change 2of2 - as shown in Arduino libary for Wire.h
